	...
	<div style="width:1000px; margin:0px auto; background-color:white; margin-top:30px">
		<table style="width:100%">
			...
			<?php
				...
				{ 	
					?>
						<tr style="height:33px; text-align:center" class="classPensionGroup" selectpension="" onclick="javascript:clickPension(this, '<?=$idx?>', '<?=$row['user_id']?>');" onmouseover="javascript:selectPension(this);" onmouseout="javascript:unSelectPension(this);">
							<td>
								<?=$idx?>
							</td>
							<td>
